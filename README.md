...
- A standalone framework module for certified finite scale families,
...
proof of it. The draft records the five-qubit NMR result as one
...
framework/    reusable normalized-scale and exact-decision mathematics
