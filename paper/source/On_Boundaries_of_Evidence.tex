...
\hypersetup{
  ...
  pdfauthor={J. Tree},
  pdfsubject={Version 1.0.1; DOI 10.5281/zenodo.21541561; a typed audit calculus for scientific transfers},
...
\date{24 July 2026\\[0.25em]\small Version \BSCVersion\quad\textbullet\quad \BSCDOI}
...
structured-cospan schema, non-invertible defects, and rigorous scale limits.  It
...
with regime & qualitative solenoidal analogy only \citep{klingman2025}\\
...
dependency readiness caps are monotone; and topology alone does not select
electric charge.  The fixtures make these statements vulnerable to exact
tests.
